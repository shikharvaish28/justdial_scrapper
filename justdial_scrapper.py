...
out_file = open('Textile-Manufacturers-in-Pune-City.csv','w')
...
while True:
	...
	url="https://www.justdial.com/Pune/Textile-Manufacturers-in-Pune-City/nct-10477448/page-%s" % (page_number)
